...
local suffixes = {
	-- 7 suffixes
	{name="Denizen", xp_modifier=0},
	{name="Apprentice", xp_modifier=1},
	{name="Adventurer", xp_modifier=2},
	{name="Knight", xp_modifier=3},
	{name="Royal", xp_modifier=5},
	{name="Wizard", xp_modifier=7},
